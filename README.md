# Info-biomedicina
Site feito para atender aos seguintes requisitos: 

AVALIAÇÃO  - PRÁTICA
CRIAR UMA  APLICAÇÃO INTERNET  QUEA CONTENHA:

1. RESPONSIVIDADE P/ ADEQUAÇÃO: A NAVEGA DORES DESKTOP E  MOBILE 
2. UM MENU DROP DOWN RESPONSIVO, QUE SEJA ADAPTÁVEL A DISPOSITIVOS  MÓVEIS. 
3. UM MÓDULO COM FORMULÁRIO RESPONSIVO QUE CONTENHA: 
3.1. CAIXA DE TEXTO 
3.2. CAIXA DE OPÇÕES DO TIPO CHECK BOX. 
3.3. UM CHECKLIST DO TIPO DROPBOX. 
3.4. UMA CAIXA DE TEXTO P/   PARAGRAFOS 
3.5. BOTÃO DE LIMPAR 
3.6. BOTÃO P/ SUBMETER 
